...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.DefaultPrefs=function()
		{
            ...
            Game.prefs.debug=0;//Debug menu toggle
		...
		*/
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='prefs')
			{
				...
				'<div class="listing">'+Game.WriteButton('autosave','autosaveButton','Autosave ON','Autosave OFF')+'<label>(enable or disable autosaving)</label></div>'+
