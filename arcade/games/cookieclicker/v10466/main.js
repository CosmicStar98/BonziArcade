...
Game.Launch = function() {
  ...
  Game.Init = function() {
    ...
    l('links').innerHTML = '<a href="../">Live version</a> | <a href="../beta/">Try the beta!</a> | <a href="../cookie/">Classic</a>';
    ...
    Game.Object = function(name, commonName, desc, icon, art, price, cps, buyFunction) {
      ...
      this.icon = icon;
      this.art = art;
      if (art.base) { art.pic = art.base + '.png'; art.bg = art.base + 'Background.png'; }
